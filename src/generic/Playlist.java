...
public class Playlist extends javax.swing.JFrame {
    ...
    KoleksiDokumen koleksi = new KoleksiDokumen();
    ...
    private void initComponents() {
        ...
        jMenuItem1.setText("Add File(s)");
        jMenuItem1.setActionCommand("addFiles");
        jMenuItem1.addActionListener(new java.awt.event.ActionListener() {
            public void actionPerformed(java.awt.event.ActionEvent evt) {
                jMenuItem1ActionPerformed(evt);
            }
        });
        popupTombol.add(jMenuItem1);

        jMenuItem2.setText("Add Folder");
        jMenuItem2.setActionCommand("addFolder");
        jMenuItem2.addActionListener(new java.awt.event.ActionListener() {
            public void actionPerformed(java.awt.event.ActionEvent evt) {
                jMenuItem2ActionPerformed(evt);
            }
        });
        popupTombol.add(jMenuItem2);

        jMenuItem3.setText("Clear Playlist");
        jMenuItem3.setActionCommand("clearPlaylist");
        jMenuItem3.addActionListener(new java.awt.event.ActionListener() {
            public void actionPerformed(java.awt.event.ActionEvent evt) {
                jMenuItem3ActionPerformed(evt);
            }
        });
        popupTombol.add(jMenuItem3);
...
//    Metod untuk mengatur pengaturan lebar dan tinggi kolom pada table
...
//    Method u/ mendapatkan ekstensi sebuah file
...
//  Method u/ mengkoleksi semua file Docx yang dipilih
    private void addFiles(File[] files){
        for (File file : files) {
            ...
            Dokumen m = new Dokumen(path,fileName,fileSize,extension);
            koleksi.add(m);
        }
    }
    
    
//    Method u/ membaca semua file Docx di dalam folder dan sub-folder
        ...
        for (File listOfFile : listOfFiles) {
            if (listOfFile.isFile()) {
                ...
                if (i > 0) {
                    ...
                    if ("docx".equalsIgnoreCase(extension) || "pdf".equalsIgnoreCase(extension)) {
                        Dokumen d = new Dokumen(path, fileName, fileSize, extension);
                        koleksi.add(d);
                    }
